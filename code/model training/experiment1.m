...
%% Data pre-collection
datafilename = 'D:\han\writing\2024.3.23hqz_scientific_data\train data\globalsite_traindata_including_aug.xlsx';
...
realdatafilename = 'D:\han\writing\2024.3.23hqz_scientific_data\train data\globalsite_traindata_excluding_aug.xlsx';
...
for i = 1:10
    ...
    % save model
%     RFModelSavePath='D:\han\writing\2024.4.12hqz_scientific_data\model\experiment1\entire data\';
%     save(sprintf('%sRF_Nee_dataaug_fold%d.mat',RFModelSavePath,i),'nTree','nLeaf',...
