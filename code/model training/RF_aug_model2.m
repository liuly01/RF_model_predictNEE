...
data_var = []; % variable
data_var(:,1) = data.data(:,6); % 595T2M
data_var(:,2) = data.data(:,7); % aveT2M
data_var(:,3) = data.data(:,8); % avePRE
data_var(:,4) = data.data(:,9); % aveSSR
data_var(:,5) = data.data(:,13); % NDVI
data_var(:,6) = data.data(:,11); % LAI
data_var(:,7) = data.data(:,12); % CO2
data_var(:,8) = data.data(:,14); % SOC
